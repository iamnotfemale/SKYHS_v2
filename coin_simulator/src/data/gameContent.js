...
export const TURNS = [
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'버티기',label:'아직은 지켜볼 때예요. 근거부터 봅시다.'},{id:'sell',dir:'sell',tag:'손절',label:'위험해 보이면 빨리 빼는 게 맞아요.'},{id:'buy',dir:'buy',tag:'추매',label:'이참에 더 담아도 되지 않을까요?'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'버티기',label:'분위기 말고 근거를 보고 판단하죠.'},{id:'sell',dir:'sell',tag:'손절',label:'인수까지 무산됐으면 빼는 게 맞죠.'},{id:'buy',dir:'buy',tag:'추매',label:'공포일 때 오히려 모아야죠.'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'버티기',label:'바로 지금이 가장 위험한 타이밍이에요.'},{id:'sell',dir:'sell',tag:'손절',label:'파산까지 갔으면 끝이죠. 손절합시다.'},{id:'buy',dir:'buy',tag:'추매',label:'바닥이면 지금 줍는 거죠.'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'관망',label:'반등은 일단 지켜보죠. 거래량을 봐요.'},{id:'sell',dir:'sell',tag:'손절',label:'오른 김에 그냥 정리해버리죠.'},{id:'buy',dir:'buy',tag:'추매',label:'지금이 기회예요, 추격매수 가시죠!'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'관망',label:'잦은 매매가 더 위험해요. 지켜봅시다.'},{id:'sell',dir:'sell',tag:'손절',label:'불안하면 지금이라도 빼죠.'},{id:'buy',dir:'buy',tag:'추매',label:'싸졌으니 더 담아두죠.'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'버티기',label:'BTC 자체는 거래소 파산과 별개예요.'},{id:'sell',dir:'sell',tag:'손절',label:'연쇄 파산이면 지금 빠져야죠.'},{id:'buy',dir:'buy',tag:'추매',label:'공포일수록 오히려 담아야죠.'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'버티기',label:'극단적 공포가 가장 강한 바닥 신호예요.'},{id:'sell',dir:'sell',tag:'손절',label:'더 버티다간 더 잃을 수도 있어요.'},{id:'buy',dir:'buy',tag:'추매',label:'바닥이면 지금이 기회죠.'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'관망',label:'거래량 확인 후 추세 잡힐 때 결정해요.'},{id:'sell',dir:'sell',tag:'익절',label:'조금 오른 지금 일부 정리해두죠.'},{id:'buy',dir:'buy',tag:'추매',label:'거래량 붙었으면 지금 타는 거죠.'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'관망',label:'횡보 구간은 매집 신호일 수 있어요.'},{id:'sell',dir:'sell',tag:'익절',label:'불확실하면 지금 일부 정리해도 돼요.'},{id:'buy',dir:'buy',tag:'추매',label:'바닥 매집 신호면 지금 담는 거죠.'}],
  ...
  },
  {
    ...
    advices:[{id:'hold',dir:'hold',tag:'버티기',label:'저항선 돌파하면 추세 전환 신호예요.'},{id:'sell',dir:'sell',tag:'익절',label:'오른 김에 손실 만회분만 털죠.'},{id:'buy',dir:'buy',tag:'추매',label:'추세 전환이면 지금 더 담는 거죠.'}],
...
export const DOGE_TURNS = [
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'분할익절',label:'이미 올랐으면 일부 수익을 현금화해두는 게 현명해요.'},
      {id:'buy',dir:'buy',tag:'풀매수',label:'오르는 추세니까 지금 더 담아야죠!'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'분할익절',label:'수익 일부를 현금화해두는 게 안전해요.'},
      {id:'buy',dir:'buy',tag:'추격',label:'추세가 강해요. 지금 더 담아야죠.'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'분할익절',label:'지금까지 오른 수익 일부를 챙기세요.'},
      {id:'buy',dir:'buy',tag:'추격',label:'밈이 이 정도면 폭발 직전이에요.'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'분할매도',label:'5배 수익이면 일부는 챙겨두세요. 욕심은 금물.'},
      {id:'buy',dir:'buy',tag:'풀매수',label:'천장이 어딘지 모르잖아요. 더 담죠!'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'익절',label:'거품이 꺼지기 전에 일부 수익을 확정하세요.'},
      {id:'buy',dir:'buy',tag:'풀매수',label:'역대급 랠리예요. 지금 올라타야죠!'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'손절',label:'BTC까지 빠지면 추가 하락 가능해요. 일부 손절도 방법.'},
      {id:'buy',dir:'buy',tag:'추매',label:'떨어졌을 때 더 담는 거죠. 도지데이가 호재잖아요.'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'손절',label:'모멘텀이 꺾였어요. 일부 손절하고 관망해요.'},
      {id:'buy',dir:'buy',tag:'추매',label:'싸진 가격에 더 담는 게 기회예요.'},
    ],
  ...
  },
  {
    ...
    advices:[
      {id:'hold',dir:'hold',tag:'버티기',label:'증세안 충격은 일시적이에요. SNL 호재가 남아있어요.'},
      {id:'sell',dir:'sell',tag:'손절',label:'불확실성이 크면 지금 일부 정리하는 것도 방법이에요.'},
      {id:'buy',dir:'buy',tag:'추매',label:'이런 급락이 저점이에요. 지금 담아야죠.'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'분할익절',label:'SNL 전 일부 수익을 챙기는 분할 매도도 좋아요.'},
      {id:'buy',dir:'buy',tag:'풀매수',label:'SNL 대형 호재에 지금 올라타야죠!'},
    ],
  ...
  },
  {
    ...
    advices:[
      ...
      {id:'sell',dir:'sell',tag:'익절',label:'정점 부근에서 익절하는 게 가장 현명한 선택이에요.'},
      {id:'buy',dir:'buy',tag:'풀매수',label:'SNL이 대형 호재예요. 마지막 기회예요!'},
    ],
